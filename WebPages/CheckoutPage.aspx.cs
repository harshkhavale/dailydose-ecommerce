...
public partial class WebPages_CheckoutPage : System.Web.UI.Page
{
    ...
    public string emailaddress = "harshkhavale1102@gmail.com";
    ...
    private void SendMail(String Email, String UserName, String EmailBody)
    {
        ...
        MailMessage PassRecMail = new MailMessage("gmail", emailaddress);
        ...
        using (SmtpClient client = new SmtpClient())
        {
            ...
            client.Credentials = new NetworkCredential("gmail", "code");
